  ...
  return (
    <aside className="fixed inset-y-0 left-0 z-40 w-64 bg-[#1e293b] flex flex-col">
      ...
      <div className="flex items-center gap-3 px-5 py-5 border-b border-slate-700">
        {settings?.logoUrl ? (
          <Image src={settings.logoUrl} alt="logo" width={36} height={36} className="rounded-lg object-contain" />
        ) : (
        ...
        <div>
          ...
          <p className="text-slate-400 text-xs">Procurement CRM</p>
        </div>
      </div>
